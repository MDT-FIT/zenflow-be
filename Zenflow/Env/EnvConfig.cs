...
namespace Zenflow.Env
{
    public static class EnvConfig
    {
        ...
        public static readonly string AuthGrantType = Environment.GetEnvironmentVariable("AUTH_GRANT_TYPE") ?? "grant my wish";

        public static readonly Uri AuthConnectUri = new Uri($"https://{AuthDomain}/dbconnections/signup");
        ...
        public static readonly string TinkGrantType = Environment.GetEnvironmentVariable("TINK_GRANT_TYPE") ?? "grant my wish";
        ...
        public static Uri TinkGetBalanceUri(string accountId) => new Uri($"{TinkApi}/api/v1/accounts/{accountId}/balances");
    }
}
